  ...
  if (!!username) {
    return (
      <div className=" flex items-center justify-between flex-1 p-2 text-gray-100">
        <div className="flex flex-col md:flex-row items-start md:items-center jutify-center gap-2">
      ...
      <div className=" flex items-center flex-1 p-2 text-gray-100">
        ...
        >
          <div className="flex items-center jutify-center w-full">
            ...
            <input
              type="text"
              className="flex-1 outline-none px-1 border h-9 border-gray-300 bg-gray-50 text-black rounded-md"
